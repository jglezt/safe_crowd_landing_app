/* Original Author: https://github.com/nyukhalov
 * Reason of this class:
 * I needed to modify the output of polylabel method in order to get the radius of the circle.
 */
...
public class Polylabel {
    ...
    public static Cell polylabel(Polygon polygon, double precision) {
        ...
        if (cellSize == 0)
            return new Cell(minX, minY, h, polygon);
